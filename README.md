...
"You don't have to remember everything that you can have on your finger. tips" ;-) Todo List is a small app made with `Hyper Text Markup Language`, `Cascading Style Sheet`, and `JavaScript` which you can use as a ready Recknor where you can save your daily tasks, mark them complete, and remove the completed tasks.
